    ...
    <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-6 sm:p-8 rounded-2xl shadow-2xl border border-gray-200 max-w-6xl mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 mt-4 text-sm sm:text-base">
          Validate model performance using cross-validation technique
        </p>
      </div>
          ...
          <div className="p-6 bg-gradient-to-r from-black to-gray-900 text-yellow-400 rounded-xl border-l-4 border-yellow-400 shadow-lg">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-6">
              <div className="bg-gray-800 p-4 rounded-lg text-center">
                <p className="text-sm text-gray-400 mb-1">Mean R² Score</p>
                <p className="text-3xl font-bold text-yellow-300">
                  {result.mean_r2.toFixed(4)}
                </p>
              </div>
              <div className="bg-gray-800 p-4 rounded-lg text-center">
                <p className="text-sm text-gray-400 mb-1">Number of Folds</p>
                <p className="text-3xl font-bold text-yellow-300">
                  {result.r2_scores.length}
                </p>
              </div>
            </div>
            ...
            <div className="bg-gray-800 p-4 rounded-lg">
              ...
              <div className="flex flex-wrap gap-2">
                {result.r2_scores.map((score, index) => (
                  <span
                    key={index}
                    className="bg-yellow-400 text-black px-3 py-1 rounded-full text-sm font-mono font-bold"
                  >
